...
public class CommentMapperTest {
    ...
    public void testInputDTOToEntity_ReturnNull() {
        ...
        assertNull(commentMapper.inputDTOToEntity(null));
    }

    @Test
    public void testToOutputDTO_ReturnNull() {

        assertNull(commentMapper.toOutputDTO(null));
    }

    @Test
    public void testToOutputDTOs_ReturnNull() {

        assertNull(commentMapper.toOutputDTOs(null));
    }

    @Test
    public void testToOutputDTOs_whenEntitiesIsEmpty() {

        assertEquals(0, commentMapper.toOutputDTOs(new ArrayList<>()).size());
    }
    ...
    public void testToOutputDTOs_whenEntitiesAreNotEmpty() {
        ...
        assertEquals(2, commentMapper.toOutputDTOs(entities).size());
